export const translations = {
  en: {
    ...
    reviews: {
      ...
      defaultReview1: 'Great quality and fast delivery! The print looks amazing on the hoodie.',
      defaultReview2: 'Really like the custom notebook I ordered. The colors are very vibrant.'
    },
    checkout: {
      ...
      freeGift: 'FREE GIFT',
      giftDesc: 'Stain remover powder included',
      product: 'Product',
      delivery: 'Delivery',
      location: 'Delivery Location',
      locationDesc: 'Aktau, Kazakhstan - Delivery available citywide',
      ...
      cashDesc: 'Pay when you receive the order',
  ...
  ru: {
    ...
    home: {
      ...
      merch: 'Мерч',
      heroDesc: 'Загрузите свой арт, выберите цвета и посмотрите, как он оживает на премиальной одежде и аксессурах — с реалистичным превью ткани.',
    ...
    reviews: {
      ...
      defaultReview1: 'Отличное качество и быстрая доставка! Принт на худи выглядит потрясающе.',
      defaultReview2: 'Очень понравился блокнот, который я заказала. Цвета очень яркие.'
    },
    checkout: {
      ...
      freeGift: 'БЕСПЛАТНЫЙ ПОДАРОК',
      giftDesc: 'Пятновыводитель в комплекте',
      product: 'Товар',
      delivery: 'Доставка',
      location: 'Место доставки',
      locationDesc: 'Актау, Казахстан - Доставка по всему городу',
      enterDetails: 'Введите данные для доставки',
      fullName: 'ФИО *',
      ...
      notesPlaceholder: 'Любые специальные инструкции для доставки...',
  ...
  kk: {
    ...
    reviews: {
      title: 'Сатып алушылардың пікірлері',
      ...
      defaultReview1: 'Өте жақсы сапа және жылдам жеткізу! Худидегі принт керемет көрінеді.',
      defaultReview2: 'Маған өзім тапсырыс берген блокнот өте ұнады. Түстері өте қанық.'
    },
    checkout: {
      ...
      giftDesc: 'Дақ кетіргіш ұнтақ жиынтықта',
      product: 'Тауар',
      delivery: 'Жеткізу',
      location: 'Жеткізу орны',
      locationDesc: 'Ақтау, Қазақстан - Қала бойынша жеткізу қолжетімді',
      ...
      building: 'Үй/Ғимарат',
      apartment: 'Пәтер',
      notes: 'Жеткізуге арналған ескертпелер',
      notesPlaceholder: 'Жеткізуге арналған кез келген арнайы нұсқаулар...',
      continue: 'Төлемге өту',
      selectPayment: 'Төлем әдісін таңдаңыз',
      cashOnDelivery: 'Алған кезде төлеу',
      cashDesc: 'Тапсырысты алған кезде төлеңіз',
      comingSoon: 'Жақында болады',
      edit: 'Өзгерту',
      back: 'Артқа',
      processing: 'Өңдеу...',
      pay: 'Төлеу'
